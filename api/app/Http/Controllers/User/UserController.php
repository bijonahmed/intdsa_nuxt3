...
class UserController extends Controller
{
    ...
    public function findUserDetails(Request $request)
    {
        ...
        $data = [
            ...
            'userInfo_5' => "WhatsApp:" . $whatsapp,
            'invite_user_1' => !empty($chkInviteUser->name) ? "Name:" . $chkInviteUser->name : "",
            'invite_user_2' => !empty($chkInviteUser->phone_number) ? "Cell Phone:" . $chkInviteUser->phone_number : "",
            'invite_user_3' => !empty($chkInviteUser->email) ? "Email:" . $chkInviteUser->email : "",
            'email'         => $item->email,
            'register_ip'   => $item->register_ip,
    ...
    public function AllUsersList(Request $request)
    {
        ...
        $modifiedCollection = $paginator->getCollection()->map(function ($item) {
            ...
            return [
                ...
                'register_country'   => $ipdat->geoplugin_countryName,
                'lastlogin_country'  => $item->lastlogin_country,
