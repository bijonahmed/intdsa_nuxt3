<template>
    ...
    <div>
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">All Transection report</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Deposit, Withdraw, Order, System, Service, comission</td>
                                        <td>$100.00</td>
                                        <td>Unpaid</td>
                                        <td>Payment not received</td>
                                        <td>2024-06-12 12:12:00</td>
                                        <td>
                                            ...
                                            <button class="btn w-100 d-block btn-danger btn-sm btn-flat"
                    ...
                    <div class="modal-body">
                        <table class="table">
                            ...
                            <tr>
                                <td>Remarks</td>
                                <td>
                                    <p>succefull Deposit</p>
                                </td>
                            </tr>
                            <tr>
                                <td>Date time</td>
                                <td>
                                    <p>2024-12-12 12:12:00</p>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <!-- edit modal  -->
        <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="detailsTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header py-1">
                        <h5 class="modal-title" id="detailsTitle">Details</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="" id="" cols="30" rows="3"
                                            class="form-control">Payment not received</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Date time</td>
                                    <td>
                                        <input type="datetime-local" value="2024-06-12T19:30" min="2024-01-07T00:00"
                                            max="2080-06-14T00:00" class="form-control">
                                    </td>
                                </tr>
                            </table>
                            <button type="submit" class="btn btn-success w-100">Save and Update</button>
                        </form>
                    </div>
                </div>
            </div>
