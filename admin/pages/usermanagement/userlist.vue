                    ...
                    <div class="modal-body">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="text-left">{{ u_details_avail_balance }}</td>
                            </tr>
                            <tr>
                                <td class="text-left">Frozen amount</td>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <small>{{ u_details_userInfo_1 }}</small><br />
                                    <small>{{ u_details_userInfo_2 }}</small><br />
                                    <small>{{ u_details_userInfo_3 }}</small><br />
                                    <small>{{ u_details_userInfo_4 }}</small><br />
                                    <small>{{ u_details_userInfo_5 }}</small><br />
